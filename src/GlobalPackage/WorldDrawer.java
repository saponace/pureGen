...
public class WorldDrawer {
	...
	// Do we render quads on the borders of the world and below the world ?
	// Speed up a lot the generation
	private static boolean minimalRendering = true;
	...
	private static void drawQuad(int x, int y, int z, Orientation orientation,
	...
	// Determine if we need to draw a quad on a given position on a given
	// orientation
	private static boolean isQuadNeeded(World world, int x, int y, int z,
			Orientation orientation) {
		if (minimalRendering
